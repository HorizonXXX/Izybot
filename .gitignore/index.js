...
client.on("ready", () => {
    ...
    client.user.setGame("Creer par </Faelwen>");

});

client.on('message', async message => { 

    if(message.content === "Té qui toi"){
        message.reply("Je suis un :robot:robot:robot:.... **Creer Par FL**....Tu veux étre Mon ami ?");
        console.log('Le bot dit bonjour');
    }

    if(message.content === "ping"){
        message.reply(":stuck_out_tongue: pong :stuck_out_tongue: ")
        console.log('le bot a fait une blague')
    }

    if(message.content === "Tu es moche"){
       message.reply("ça a le mérite d'étre clair. Mais c'est pas trés Sympa :sob: ")
       console.log("le bot est triste")
    }

    if(message.content === "Tu es jolie"){
       message.reply("Je connaissais L'expression **Beau comme un camion** Mais Beau Comme un algorithme, je ne l'entend pas souvent, Merci ! :stuck_out_tongue_winking_eye: ")
    }

    if(message.content === "Fairytail ?"){
      message.reply("Fairy bot ? La difference ? un jour un sage fadelilio54 a dit **Fairytail c'est la vie !**")
    }

    if(message.content === "Magie"){
      message.reply(":sunglasses: *SHOUR SHOUR 2.0 !* :sunglasses: ")
    }
    ...
    if(message.content === prefix + "help") {
      ...
      .setFooter("Menu d'aide - Fairybot")
      .setTimestamp()
    ...
    if(message.content === prefix + "mod") {
      ...
      .setFooter("Commande modération - FairyBot")
      .setTimestamp()
    ...
    if(message.content === prefix + "fun") {
      ...
      .setColor('RANDOM')
      .setTitle(`:tools: Voici mes commandes !`)
      .setThumbnail(message.author.avatarURL)
      ...
      .addField("*play", "Cette Commande Est en dev")
      .addField("ping", "Le Bot vous fait une blague" )
      .addField("Té qui toi", "Le bot vous fait une blague")
      .addField("Tu es moche ", "Le bot est triste !")
      .addField("Tu es jolie", "le bot vous répond")
      .addField("Fairytail ?", "le bot vous répond")
      .addField("*Magie", "le Bot vous Fait une blague")
      .setFooter("Commande Fun- FairyBot")
      .setTimestamp()
      message.channel.send(fun_embed);
    }
    
    if(message.content === prefix + "desc") {
      var Desc_embed = new Discord.RichEmbed()
      .setColor('RANDOM')
      .setTitle(`:tools: Voici ma description !`)
      .addField("Salut ! je suis le :robot: Creer Par FL le 2/10/2018 et la alpha 1 est fini le 11/11/2018 !")
      .setThumbnail(message.author.avatarURL)
      .setTimestamp()
      message.channel.send(Desc_embed);
    }
